...
const routes: {
  ...
  },
  {
    ...
    description:
      "تعرّف على عِمارة: منصة سعودية تربط ملاك العقارات بشركات إدارة مرافق موثّقة ومراجَعة يدوياً، بعروض تنافسية وتعاقد شفاف.",
  },
  {
    route: "/contact",
  ...
  },
  {
    ...
    description:
      "سجّل مجاناً في عِمارة. الملاك ينشرون احتياج عقارهم ويستقبلون عروضاً مكتوبة من شركات إدارة مرافق موثّقة، ورقم الجوال لا يظهر إلا بعد قبول العرض.",
  },
];
