    ...
    ar: {
      ...
      whoMoments: [
        ...
        },
        {
          ...
          desc: "عمارتك تحتاج تشغيلاً وصيانة من أول يوم. أضف عقارك خلال دقائق، واستقبل عروض شركات إدارة المرافق في مكان واحد.",
        },
        {
      ...
      step1Desc: "أضف تفاصيل عِمارتك (سكني أو تجاري) وانشر طلباً شاملاً لتشغيل وصيانة عقارك",
