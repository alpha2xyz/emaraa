...
export default function AuthPage() {
  ...
  const content = {
    ar: {
      ...
      ownerDesc: "أدير عقاراتي وأطلب خدمات إدارة المرافق",
      providerDesc: "تقديم خدمات إدارة المرافق",
    ...
    en: {
      ...
      ownerDesc: "Manage my properties and request facility management services",
      providerDesc: "Provide facility management services",
      nameLabel: "Full Name",
